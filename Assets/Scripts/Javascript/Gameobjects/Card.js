		...
		var text ="";
			...
			switch(this.id){
				...
				case 5 :if(this.color==="pic"||this.color==="trefle"){
							text = "le joueur qui a retourné la carte doit boire "+(this.id+1)+" gorgées!";
						}else{
							text = "le joueur qui a retourné la carte fait boire "+(this.id+1)+" gorgées a un autre joueur!";
						}
				break;
				case 6 :text = "le joueur qui a retourné la carte devient maitre des statues!";
				break;
				case 7 :text = "le joueur qui a retourné la carte devient maitre des pouces!";
				break;
				case 8 :text = "le joueur qui a retourné la carte devient maitre des questions!";
				break;
				case 9 :text = "le joueur qui a retourné la carte doit inventer une règles!";
				break;
				case 10 :text = "les homme boivent!";
				break;
				case 11 :text = "les femmes boivent!";
				break;
				case 12 :text = "le joueur qui a retourné la carte donne un thème, le perdant fini son verre!";
				break;
				case 13 : if(this.color==="pic"||this.color==="trefle"){
							text = "le joueur qui a retourné la carte doit vider son verre!";
						}else{
							text = "le joueur qui a retourné la carte oblige un autre joueur a finir son verre!";
						}
				break;
			}
